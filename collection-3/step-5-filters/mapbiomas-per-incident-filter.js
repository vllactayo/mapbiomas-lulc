...
var param = {
    ...
    version_input_class:2, //  Clasificacion de entrada (ojo no es el paso 13-1)
    version_output:3, //    Salida 
...
var dirin = paths.clasificacionFiltros
...
var classification_input = ee.ImageCollection(dirin)
