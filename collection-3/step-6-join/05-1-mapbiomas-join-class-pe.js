...
var param = {
    ...
    version_input: 24, //COLECCION 5
    version_output:25, //COLECCION 5
    List_year_add: [2021, 2023], // Año a agregar de COLECCION 5
    remap: {  // Remap coleccion4
      from: [3, 4, 5, 6, 9, 11, 12, 13, 14, 15, 18, 19, 20, 21, 22, 23, 24, 25, 26, 29, 30, 31, 32, 33, 34],
      to:   [3, 4, 5, 6, 9, 11, 12, 13, 14, 15, 18, 19, 20, 21, 22, 23, 22, 25, 26, 29, 30, 31, 32, 33, 34]
    },
};
